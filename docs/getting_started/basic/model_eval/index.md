...
## Assumed Knowledge
We will start with the assumption that you are familiar with the basic FiftyOne dataset structure [LINK] and early computer vision concepts. This tutorial is recommended for beginners new to computer vision or FiftyOne. It will be helpful if you have run a model in FiftyOne or at worked with data that has both a "ground truth" and a "predictions" label
